...
class AppListenerManager {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            switch (int) {
                ...
                case compiler_1.AppInterface.IPostRoomDeleted:
                    ...
                    return;
                // External Components
                case compiler_1.AppInterface.IPostExternalComponentOpened:
                    this.executePostExternalComponentOpened(data);
                    return;
                case compiler_1.AppInterface.IPostExternalComponentClosed:
                    this.executePostExternalComponentClosed(data);
                    return;
                case compiler_1.AppInterface.IUIKitInteractionHandler:
                    return this.executeUIKitInteraction(data);
                // Livechat
                case compiler_1.AppInterface.ILivechatRoomClosedHandler:
                    this.executeLivechatRoomClosed(data);
                    return;
                default:
    ...
    executePostExternalComponentOpened(data) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const appId of this.listeners.get(compiler_1.AppInterface.IPostExternalComponentOpened)) {
                const app = this.manager.getOneById(appId);
    ...
    executePostExternalComponentClosed(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const cfExternalComponent = Utilities_1.Utilities.deepCloneAndFreeze(data);
            for (const appId of this.listeners.get(compiler_1.AppInterface.IPostExternalComponentClosed)) {
                const app = this.manager.getOneById(appId);
    ...
    // Livechat
    executeLivechatRoomClosed(data) {
        return __awaiter(this, void 0, void 0, function* () {
            const cfLivechatRoom = Utilities_1.Utilities.deepCloneAndFreeze(data);
            for (const appId of this.listeners.get(compiler_1.AppInterface.ILivechatRoomClosedHandler)) {
                const app = this.manager.getOneById(appId);
