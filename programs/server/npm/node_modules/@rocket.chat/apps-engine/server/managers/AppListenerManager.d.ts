...
export declare class AppListenerManager {
    ...
    executeListener(int: AppInterface, data: IMessage | IRoom | IUser | ILivechatRoom | IUIKitIncomingInteraction | IExternalComponent): Promise<void | boolean | IMessage | IRoom | IUser | IUIKitResponse | ILivechatRoom>;
    ...
    private executeLivechatRoomClosed;
}
