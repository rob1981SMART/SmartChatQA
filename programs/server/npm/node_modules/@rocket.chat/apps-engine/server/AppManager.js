...
class AppManager {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const rl of this.apps.values()) {
                if (!AppStatus_1.AppStatusUtils.isDisabled(rl.getStatus()) && AppStatus_1.AppStatusUtils.isEnabled(rl.getPreviousStatus())) {
                    yield this.enableApp(items.get(rl.getID()), rl, true, rl.getPreviousStatus() === AppStatus_1.AppStatus.MANUALLY_ENABLED).catch(console.error);
                }
            }
            this.isLoaded = true;
            return affs;
    ...
    unload(isManual) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            for (const rl of this.apps.values()) {
                ...
                if (rl.getStatus() === AppStatus_1.AppStatus.INITIALIZED) {
                ...
                yield this.disable(rl.getID(), isManual ? AppStatus_1.AppStatus.MANUALLY_DISABLED : AppStatus_1.AppStatus.DISABLED);
            }
    ...
    disable(id, status = AppStatus_1.AppStatus.DISABLED, silent) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (AppStatus_1.AppStatusUtils.isEnabled(rl.getStatus())) {
                yield rl.call(metadata_1.AppMethod.ONDISABLE, this.accessorManager.getConfigurationModify(rl.getID()))
            ...
            this.apiManager.unregisterApis(rl.getID());
            this.accessorManager.purifyApp(rl.getID());
            yield rl.setStatus(status, silent);
            const storageItem = yield this.storage.retrieveOne(id);
            rl.getStorageItem().marketplaceInfo = storageItem.marketplaceInfo;
            yield rl.validateLicense().catch();
            // This is async, but we don't care since it only updates in the database
            // and it should not mutate any properties we care about
            storageItem.status = rl.getStatus();
            yield this.storage.update(storageItem).catch();
